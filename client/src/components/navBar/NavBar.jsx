  ...
  return (
    <Box className="navbar">
      <Box fluid className="navbar-container">
        ...
        <Link to="/" className="navitem navlogo bs-logo">
          <img src={BsLogo} alt="Bs-logo" width={150} />
        </Link>
        <Link to="/" className="navitem navlogo Ss-logo">
          <img src={SsLogo} alt="Ss-logo" width={25} />
        </Link>
        <Link to="/" className="navitem navbtn navitem-h">
          <p>Home</p>
        </Link>
        <Link to="/" className="navitem navbtn nav-products">
          <p>Products</p>
        </Link>
        <Link to="/" className="navitem navbtn navitem-h">
          <p>For our teams</p>
